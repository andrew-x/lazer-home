...
| [0044](./0044-performance-dashboards-split-by-permission.md) | `/performance` split into two gated dashboards (Compensation + Performance/levels); `/performance` becomes a permission-aware redirect | accepted; **routes moved** by [0055](./0055-nav-dashboards-vs-people-management.md) (`/dashboards/*` + `/people/*`) — the split itself stands |
