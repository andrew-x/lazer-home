...
[ADR 0067](./0067-delivery-managers-as-project-roles-and-coverage-gaps.md)**) and a date range:
...
- **Which flags a viewer sees depends on their capability.** Without `projects.viewMargin`,
  ...
  > unrated projects.
  >
  > **Amended again by [ADR 0067](./0067-delivery-managers-as-project-roles-and-coverage-gaps.md):**
