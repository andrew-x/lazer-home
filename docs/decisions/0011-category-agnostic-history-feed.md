...
- **Adding a history source is local and additive:** a new query + projection in `getMyHistory`, plus extending the `HistoryCategory` union and the label map. No change to the page or the timeline.
