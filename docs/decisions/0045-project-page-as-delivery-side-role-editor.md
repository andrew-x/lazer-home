...
[ADR 0067](./0067-delivery-managers-as-project-roles-and-coverage-gaps.md), so the union is
...
> **Partly superseded by [ADR 0067](./0067-delivery-managers-as-project-roles-and-coverage-gaps.md).**
