...
- **CRM slice** (`src/lib/db/crm-schema.ts`, barrelled by `schema.ts`; migrations `drizzle/0012_spotty_mysterio.sql`, `drizzle/0013_clean_firelord.sql` (adds `contacts.phone`), `drizzle/0014_nostalgic_crusher_hogan.sql` + `drizzle/0017_material_korvac.sql` (restructures `opportunity_status` to 14 leaf values, adds `opportunities.position`)):
