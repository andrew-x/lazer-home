...
| [domains/performance.md](./domains/performance.md) | Peer feedback + compensation dashboard + staff rating levels L0–L4 with per-role subratings + compensation change plans (built); reviews, goals, growth (proposed) |
