...
| [domains/staff-profiles.md](./domains/staff-profiles.md) | People, roles, skills, compensation, availability; the **viewer-dependent** profile tab set (5–8 tabs), the read-only profile drawer (3–9) + the `/staff` **org chart** view |
